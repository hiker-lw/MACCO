...
class CsvDataset(Dataset):
    def __init__(self, input_filename, transforms, img_key, caption_key, hard_captions_key, sep="\t"):
        ...
        df = pd.read_csv(os.path.join(self.root_path, input_filename), sep=sep, converters={"neg_caption":ast.literal_eval, "neg_image":ast.literal_eval})
    ...
    def __getitem__(self, idx):
        ...
        new_images = self.transforms(Image.open(os.path.join(self.data_path, str(self.images[chose_image_index]))))
